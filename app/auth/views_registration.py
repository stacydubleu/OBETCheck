...
def register():
    ...
    if form.validate_on_submit():
        ...
        send_email(current_app.config['OBET_ADMIN'], 'New User Information', 'email/adminConfirmation', name = name, email = email, reason = reason)
...
def before_request():
    ...
    print('user is anonymous', current_user.is_anonymous())
    #print('user is admin', current_user.is_adminstrator())
